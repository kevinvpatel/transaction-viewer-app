class Reg {
  ...
  Reg.fromJson(Map<dynamic, dynamic> json) {
...
class Rules {
  ...
  Rules.fromJson(Map<dynamic, dynamic> json) {
...
class Patterns {
  ...
  Patterns.fromJson(Map<dynamic, dynamic> json) {
    regex = json['regex'];
...
class DataFields {
  ...
  DataFields.fromJson(Map<dynamic, dynamic> json) {
...
class Pan {
  ...
  Pan.fromJson(Map<dynamic, dynamic> json) {
...
class PosRules {
  ...
  PosRules.fromJson(Map<dynamic, dynamic> json) {
    value = json['value'];
...
class PosTypeRules {
  ...
  PosTypeRules.fromJson(Map<dynamic, dynamic> json) {
    if (json['rules'] != null) {
      rules = <PosRules>[];
      json['rules'].forEach((v) {
...
class Amount {
  ...
  Amount.fromJson(Map<dynamic, dynamic> json) {
    groupId = json['group_id'];
  }
...
class NetworkReferenceId {
  ...
  NetworkReferenceId.fromJson(Map<dynamic, dynamic> json) {
    groupId = json['group_id'];
    isNeft = json['is_neft'];
    isUpi = json['is_upi'];
    isImps = json['is_imps'];
...
class Acc {
  ...
  Acc.fromJson(Map<dynamic, dynamic> json) {
    blacklistRegex = json['blacklist_regex'];
    minAppVersion = json['min_app_version'];
    if (json['rules'] != null) {
      rules = <Rules>[];
...
class Formats {
  ...
  Formats.fromJson(Map<dynamic, dynamic> json) {
    useSmsTime = json['use_sms_time'];
    format = json['format'];
  }
...
class CreateTxn {
  ...
  CreateTxn.fromJson(Map<dynamic, dynamic> json) {
    amount =
    json['amount'] != null ? Amount.fromJson(json['amount']) : null;
  }
...
class TransactionTypeRule {
  ...
  TransactionTypeRule.fromJson(Map<dynamic, dynamic> json) {
    if (json['rules'] != null) {
...
class TransactionRules {
  ...
  TransactionRules.fromJson(Map<dynamic, dynamic> json) {
...
class TypeRules {
  ...
  TypeRules.fromJson(Map<dynamic, dynamic> json) {
    value = json['value'];
    isNeft = json['is_neft'];
    isRtgs = json['is_rtgs'];
    isUpi = json['is_upi'];
...
class Pnr {
  ...
  Pnr.fromJson(Map<dynamic, dynamic> json) {
    groupId = json['group_id'];
    groupIds = json['group_ids'] != null ? List<int>.from(json['group_ids'].map((x) => x)) : [];
  }
...
class EventReminderSpan {
  ...
  EventReminderSpan.fromJson(Map<dynamic, dynamic> json) {
    value = json['value'];
  }
...
class MiscInformation {
  ...
  MiscInformation.fromJson(Map<dynamic, dynamic> json) {
...
class GetBalance {
  ...
  GetBalance.fromJson(Map<dynamic, dynamic> json) {
    accountType = json['account_type'];
...
class ContactInfo {
  ...
  ContactInfo.fromJson(Map<dynamic, dynamic> json) {
    type = json['type'];
